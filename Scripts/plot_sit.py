...
def plotSITsingle(directory,lats,lons,sit,month,year,var,style,thresh):
    """
    ...
    cs = m.contourf(lons[:,:],lats[:,:],sit[year,month,:,:],
...
### Call functions
lats,lons,sit = readPiomas(directorydata)
#plotSITsingle(directoryfigure,lats,lons,sit,2,0,'thick','ortho',0.0)
