...
ax1 = plt.subplot(231)
plt.scatter(sitpi[0,:,:],siti[0,:,:],label='2004',color='seagreen',zorder=2,s=2)
...
ax1.text(0,6.2,r'2004',color='seagreen',fontsize=11)
ax1.text(4.7,0.5,r'r$^2$= %s' % round(r1,2),color='k',fontsize=7)

ax2 = plt.subplot(232)
plt.scatter(sitpi[1,:,:],siti[1,:,:],label='2005',color='seagreen',zorder=2,s=2)
...
ax2.text(0,6.2,r'2005',color='seagreen',fontsize=11)
ax2.text(4.7,0.5,r'r$^2$= %s' % round(r2,2),color='k',fontsize=7)

ax3 = plt.subplot(233)
plt.scatter(sitpi[2,:,:],siti[2,:,:],label='2006',color='seagreen',zorder=2,s=2)
plt.plot(timex,timey,color='k',linewidth=3,zorder=1)
...
ax3.text(0,6.2,r'2006',color='seagreen',fontsize=11)
ax3.text(4.7,0.5,r'r$^2$= %s' % round(r3,2),color='k',fontsize=7)

ax4 = plt.subplot(234)
plt.scatter(sitpi[3,:,:],siti[3,:,:],label='2007',color='seagreen',zorder=2,s=2)
plt.plot(timex,timey,color='k',linewidth=3,zorder=1)
...
ax4.text(0,6.2,r'2007',color='seagreen',fontsize=11)
ax4.text(4.7,0.5,r'r$^2$= %s' % round(r4,2),color='k',fontsize=7)

ax5 = plt.subplot(235)
plt.scatter(sitpi[4,:,:],siti[4,:,:],label='2008',color='seagreen',zorder=2,s=2)
plt.plot(timex,timey,color='k',linewidth=3,zorder=1)
...
ax5.text(0,6.2,r'2008',color='seagreen',fontsize=11)
ax5.text(4.7,0.5,r'r$^2$= %s' % round(r5,2),color='k',fontsize=7)

ax6 = plt.subplot(236)
plt.scatter(sitpi[5,:,:],siti[5,:,:],label='2009',color='seagreen',zorder=2,s=2)
plt.plot(timex,timey,color='k',linewidth=3,zorder=1)
...
ax6.text(0,6.2,r'2009',color='seagreen',fontsize=11)
...
plt.savefig(directoryfigure + 'yrtest.png',dpi=300)
