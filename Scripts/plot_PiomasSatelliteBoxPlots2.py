...
dataq = [varx1,vary1,varx2,vary2,varx3,vary3,varx4,vary4,varx5,vary5]

timex = np.arange(1,11,1)
means = np.zeros((10))
maxes = np.zeros((10))
mins = np.zeros((10))
...
plt.text(1.04,-0.25,r'\textbf{2011}',fontsize=13)
plt.text(3.04,-0.25,r'\textbf{2012}',fontsize=13)
plt.text(5.04,-0.25,r'\textbf{2013}',fontsize=13)
plt.text(7.04,-0.25,r'\textbf{2014}',fontsize=13)
plt.text(9.04,-0.25,r'\textbf{2015}',fontsize=13)

plt.text(10.3,4.8,r'PIOMAS',fontsize=18,color='darkgrey',ha='right')
plt.text(10.3,4.4,r'CryoSat-2',fontsize=18,color='rosybrown',ha='right')
